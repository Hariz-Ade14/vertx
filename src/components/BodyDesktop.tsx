...
function BodyDesktop() {
  ...
  return (
    <Layout>
      <div className="md:flex flex-col gap-3 left-[300px] top-[113px] absolute bottom-0 hidden bg-black/95 px-10 right-0 h-screen overflow-y-scroll py-5">
        ...
        <div className="bg-black w-[100%] items-start justify-between gap-4 p-5 border border-solid border-[#1D1D1D] flex gap-4 rounded-[20px] gap-3">
          <div className="flex flex-col w-[65%]">
            <h1 className="text-[25px] font-light text-white m-0">Demographics</h1>
